...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (d == true) {
            System.out.println("You have been kicked out for making too high of a bet :(");
        }
        System.out.println("You have $" + betSum + " left, thank you thank you for playing :)");
    }
